 ...
 */
class Version20150223200609 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE product ADD CONSTRAINT FK_D34A04ADD44F05E5 FOREIGN KEY (images_id) REFERENCES media__gallery (id)');
        $this->addSql('CREATE INDEX IDX_D34A04ADD44F05E5 ON product (images_id)');
        $this->addSql('ALTER TABLE product_audit ADD images_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE product_audit DROP images_id');
    }
}
